<HTML>
<HEAD>
<TITLE>таблица для заполнения БД каталога</TITLE>
</HEAD>
<BODY>
	<table width="800" height=100% border="1" align="center" cellspacing="0" cellpadding="0">
	<tr> <td  colspan="2" height=5% bgcolor="#6666FF" align="center"><?php include("delete.php"); ?></td> </tr>
	<tr>
	...
	<td   bgcolor="#9999CC" valign="top">
		...
		<FORM ACTION="delbook.php">
			<br /><h2>Введите id книги для ее удаления:</h2>
